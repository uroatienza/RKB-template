...
<?php if ($category) : ?>
	...
	<div class="floatbox">
		...
		<?php endif; ?>
         ...
         <?php if (($image = $category->getImage('content.teaser_image')) && $this->params->get('template.show_categories_images')) : ?><p style="margin: 0;"><a href="<?php echo $link; ?>" title="<?php echo $category->name; ?>">Read More »</a></p><?php endif; ?>        
